...
import dev.dukedarius.HytaleIndustries.UI.BasicItemCacheUIPage;
import org.checkerframework.checker.nullness.compatqual.NonNullDecl;
import org.checkerframework.checker.nullness.compatqual.NullableDecl;

/**
 * Opens the Basic Item Cache UI when the player uses the cache block.
 */
public class OpenBasicItemCacheInteraction extends SimpleBlockInteraction {
    ...
    public static final BuilderCodec<OpenBasicItemCacheInteraction> CODEC = BuilderCodec.builder(
            ...
            .documentation("Opens the Basic Item Cache UI")
            .build();
    ...
    protected void interactWithBlock(
        ...
        var page = new BasicItemCacheUIPage(playerRef, pos);
