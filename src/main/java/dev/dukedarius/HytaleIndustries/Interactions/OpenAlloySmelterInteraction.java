...
import dev.dukedarius.HytaleIndustries.UI.AlloySmelterUIPage;
import dev.dukedarius.HytaleIndustries.HytaleIndustriesPlugin;
import org.checkerframework.checker.nullness.compatqual.NonNullDecl;
import org.checkerframework.checker.nullness.compatqual.NullableDecl;

public class OpenAlloySmelterInteraction extends SimpleBlockInteraction {

    public static final BuilderCodec<OpenAlloySmelterInteraction> CODEC = BuilderCodec.builder(
            OpenAlloySmelterInteraction.class,
            OpenAlloySmelterInteraction::new,
            SimpleBlockInteraction.CODEC
    ).documentation("Opens Alloy Smelter UI.").build();
    ...
    protected void interactWithBlock(@NonNullDecl World world,
        ...
        var page = new AlloySmelterUIPage(playerRef, pos);
