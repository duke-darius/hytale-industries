...
import dev.dukedarius.HytaleIndustries.UI.PoweredFurnaceUIPage;
import org.checkerframework.checker.nullness.compatqual.NonNullDecl;
import org.checkerframework.checker.nullness.compatqual.NullableDecl;

public class OpenPoweredFurnaceInteraction extends SimpleBlockInteraction {

    public static final BuilderCodec<OpenPoweredFurnaceInteraction> CODEC = BuilderCodec.builder(
            OpenPoweredFurnaceInteraction.class,
            OpenPoweredFurnaceInteraction::new,
            SimpleBlockInteraction.CODEC
    ).documentation("Opens Powered Furnace UI.").build();
    ...
    protected void interactWithBlock(@NonNullDecl World world,
        ...
        var inv = entity.getStore().getComponent(entity, dev.dukedarius.HytaleIndustries.HytaleIndustriesPlugin.INSTANCE.getPoweredFurnaceInventoryType());
        if (inv == null) { interactionContext.getState().state = InteractionState.Skip; return; }
        ...
        var page = new PoweredFurnaceUIPage(playerRef, pos);
