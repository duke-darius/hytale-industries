...
import dev.dukedarius.HytaleIndustries.UI.WindTurbineUIPage;
import org.checkerframework.checker.nullness.compatqual.NonNullDecl;
import org.checkerframework.checker.nullness.compatqual.NullableDecl;

public class OpenWindTurbineInteraction extends SimpleBlockInteraction {

    public static final BuilderCodec<OpenWindTurbineInteraction> CODEC = BuilderCodec.builder(
            OpenWindTurbineInteraction.class,
            OpenWindTurbineInteraction::new,
            SimpleBlockInteraction.CODEC
    ).documentation("Opens Wind Turbine UI.").build();
    ...
    protected void interactWithBlock(@NonNullDecl World world,
        ...
        var turbineType = dev.dukedarius.HytaleIndustries.HytaleIndustriesPlugin.INSTANCE.getWindTurbineComponentType();
        if (entity == null || turbineType == null || entity.getStore().getComponent(entity, turbineType) == null) {
            interactionContext.getState().state = InteractionState.Skip;
            return;
        }
        ...
        var page = new WindTurbineUIPage(playerRef, pos);
