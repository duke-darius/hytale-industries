...
public class PoweredCrusherInventoryAdapter implements InventoryAdapter {
    @Override
    public List<MachineInventory> adapt(World world, Store<ChunkStore> store, int x, int y, int z) {
        ...
        PoweredCrusherInventory inv = store.getComponent(entity, HytaleIndustriesPlugin.INSTANCE.getPoweredCrusherInventoryType());
    ...
    private static void ensure(PoweredCrusherInventory inv) {
